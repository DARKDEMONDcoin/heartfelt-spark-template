...
import { ArrowLeft, BarChart3, BrainCircuit, CalendarCheck2, Check, CheckCircle2, Code2, Instagram, Loader2, LockKeyhole, Megaphone, MessageCircle, MessageSquareText, SearchCheck, Send, ShoppingBag, Sparkles, Workflow } from "lucide-react";
...
export function EditorialHomepage() {
  ...
  return <div className="sahl-white-home" dir="rtl">
    <section className="sahl-hero" aria-labelledby="home-title"><div className="sahl-hero-ribbon" aria-hidden="true"><i /><i /><i /></div><div className="sahl-shell sahl-hero-layout"><Reveal className="sahl-hero-copy"><p className="sahl-live-metric">١٠٨ قدرة جاهزة · ٤٠ تكاملاً · <b>٦ موظفين بالعربية</b></p><h1 id="home-title">ستة موظفين بالذكاء الاصطناعي.<br />مشروع واحد <em>يتحرك كل يوم.</em></h1><p className="sahl-first-claim">أول منصة ذكاء اصطناعي عربية.</p><p className="sahl-lead">لأصحاب المتاجر والعيادات والمطاعم والمكاتب في العالم العربي: سِراج وأمَل وسالم ونور ودانة وآدم يكتبون ويصممون ويبيعون وينظمون ويحللون بلهجة جمهورك — وأنت تعتمد قبل أي تنفيذ.</p><div className="sahl-actions"><Button asChild size="lg"><Link to="/auth" search={{ mode: "signup" as const }}>كوّن فريقك مجانًا <ArrowLeft /></Link></Button><Button asChild size="lg" variant="outline"><Link to="/auth" search={{ mode: "signup" as const }}><span className="sahl-google-mark" aria-hidden="true">G</span> ابدأ باستخدام Google</Link></Button></div><small><CheckCircle2 /> تجربة ١٤ يومًا · لا نطلب بطاقة بنكية</small></Reveal></div></section>
